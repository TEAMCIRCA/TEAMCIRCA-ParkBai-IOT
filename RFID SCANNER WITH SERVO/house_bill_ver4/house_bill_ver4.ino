  ...
  if (rfidvalue != "") {
    ...
    if (balance < 100) {
      ...
      if (accountStatus == "offline") {
        ...
        // Parking In logic
        performParkingIn(rfidvalue, currentDate);
        openTollGate();
        displayMessageParkIn();

      } else if (accountStatus == "online") {
        // Parking Out logic
        performParkingOut(driver, rfidcard, rfidvalue, currentDate, balance, firstname, phonenumber, driverLicense, currentDateWordFormat,
...
void performParkingIn(String rfidvalue, String currentDate) {
...
void performParkingOut(String driver, String rfidcard, String rfidvalue, String currentDate,
                       int balance, String firstname, String phonenumber, String driverLicense, String currentDateWordFormat,
